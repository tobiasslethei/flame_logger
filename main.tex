...
Interpolating the scattered measurements onto a regular grid produces the temperature field shown in Figure~\ref{fig:heatmap}. The peak region is centered near the wick at the start and becomes thinner and slightly tilted as the burn progresses, consistent with visual observations of the flame leaning.

\begin{figure}[H]
\centering
\includegraphics[width=0.3\textwidth]{data/figures/experiment_plot_3.png}
\caption{Interpolated temperature field revealing the hottest core near the wick with characteristic thinning and tilting as the flame evolves.}
\label{fig:heatmap}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{data/figures/experiment_plot_4.png}
